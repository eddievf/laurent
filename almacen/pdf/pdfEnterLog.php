...
<head>
	...
	<title>[PYMAQ] PDF - Ingresos al Almacén</title>
...
<div class="container">
	<table width="100%" style="margin-bottom: 20px; border-bottom: 1px solid #0E2F44; vertical-align: bottom; font-family: serif; font-size: 9pt; color: #000000;">
		<tr>
			...
			<td width="33%" align="center"><span style="font-family: Arial; color: #000000; font-weight: bold; font-size:16pt;">ALMACEN<br>Ingreso al Almacén 
				<?php
					if($fechaA == $fechaB){
...
<?php
	...
	$mpdf->Output($atwhat.'_ingresos.pdf', 'I');
