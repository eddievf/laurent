...
<head>
	...
	<title>ENVIADO - REPORTE INGRESOS ALMACEN</title>
...
<div class="container">
	<table width="100%" style="margin-bottom: 20px; border-bottom: 1px solid #0E2F44; vertical-align: bottom; font-family: serif; font-size: 9pt; color: #000000;">
		<tr>
			...
			<td width="33%" align="center"><span style="font-family: Arial; color: #000000; font-weight: bold; font-variant: small-caps; font-size:16pt;">ALMACEN<br>Ingresos al Almacen 
				<?php
					if($fechaA == $fechaB){
...
<?php
	...
	$msgbody = "<p><h2>Reporte de Ingresos Almacén</h2>
    <h3><i>Departamento de Almacén e Inventario</i></h3>
    <i>Responsable: Daniel Eduardo</i><br></p>
    <hr />
    <p>Reporte de Consumibles recibidos en Almacén, que abarca del <u> ".$fechaA." al ".$fechaB."</u></p>
	...
	$message = Swift_Message::newInstance()
		->setSubject('REPORTE - Ingresos al Almacén')
