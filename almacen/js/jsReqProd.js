        ...
        fields: [
            ...
            },
            {
                ...
                headerTemplate: function() {
                    return $("<button>").attr("type", "button").attr("class", "btn btn-primary").text('Enviar')
                            .on("click", function () {
                                var items = $("#jsReqProd").jsGrid("option", "data");
                                sendToFile(items);
                            });
                }
            }
